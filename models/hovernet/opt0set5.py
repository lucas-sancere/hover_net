...
# Same as opt8set4 but use of Image net as pretraining and not the last hovernet training
            ...
            # },
            {
                "run_info": {
                    ...
                    "net": {
                        ...
                        # None to start from scratch
                        #'pretrained': 'path',
                        "pretrained": "/data/lsancere/Hover_Net_Complete/pytorch-final/hover_net/logs_DLBCL/opt2set3/00/net_epoch=50.tar",
                        # Pretraining is with imagenet
                    },
                },
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
